...
//        ).start(this.getApplication());
    ...
    private void init(){
        ...
        btnSpecialistLogin = findViewById(R.id.signinSpecialist);
        btnSpecialistLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(DoctorLoginActivity.this,SpecialistLoginActivity.class);
    ...
    private void login(){
        ...
        if(username.trim().length() == 0 ||username == null){
            Toast.makeText(DoctorLoginActivity.this, "Please enter username", Toast.LENGTH_LONG).show();
            txtUsername.requestFocus();
            return;
        }
        if(password.trim().length() == 0 ||password == null){
            Toast.makeText(DoctorLoginActivity.this, "Please enter password", Toast.LENGTH_LONG).show();
            txtPassword.requestFocus();
            return;
        }

        final ProgressDialog dialog = new ProgressDialog(DoctorLoginActivity.this);
